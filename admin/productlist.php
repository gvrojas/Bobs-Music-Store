	...
	<tbody>
		...
		<?php foreach ($products as $product) : ?>
			...
			<td align="center" style="padding-top: 4px; padding-bottom: 4px;">
				<a href="../manager/editproduct.php?id=<?php echo $product['abbrvName']; ?>" class="btn btn-default btn-sm"
			...
			<td align="center" style="padding-top: 4px; padding-bottom: 4px;">
				<a href="../manager/deleteproduct.php?id=<?php echo $product['abbrvName']; ?>" class="btn btn-default btn-sm"
